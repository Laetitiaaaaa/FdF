...
/*   Updated: 2019/03/04 16:32:45 by llejeune         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_free(t_my_m *m)
{
	...
	m->img_ptr != NULL ? mlx_destroy_image(m->mlx_ptr, m->img_ptr) : 0;
	m->win_ptr != NULL ? mlx_destroy_window(m->mlx_ptr, m->win_ptr) : 0;
	close(m->fd);
	exit(0);
}
